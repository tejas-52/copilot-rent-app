...
const features = [
  { icon: Sparkles, label: "AI Document Review" },
  { icon: Zap, label: "Rental Confidence" },
  { icon: Bot, label: "AI Assistant" },
  { icon: FileCheck2, label: "Instant Report" },
];
        ...
        <div className="relative hidden overflow-hidden lg:flex lg:flex-col lg:justify-between lg:p-12 gradient-hero">
          ...
          >
            ...
            <p className="mt-4 text-base text-muted-foreground">
              RentReady AI helps you prepare a stronger rental application before
              submission — verified, complete, and ready to send.
            </p>
          ...
          <div className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} RentReady AI
          </div>
        </div>
        ...
        <div className="flex items-center justify-center p-6 md:p-12">
          ...
          >
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Sign in to continue your rental application.
            </p>
            ...
            >
              <Sparkles className="h-4 w-4" /> Continue as Demo
            </button>
